...
lib.ssMetadata = [
		{name:"Untitled_3_atlas_1", frames: [[736,760,600,600],[1026,0,640,351],[0,0,1024,758],[1026,353,640,320],[0,760,734,720]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(10,542,0.16,0.16);

	this.instance_1 = new lib.Bitmap9();
	this.instance_1.setTransform(133,556,0.0947,0.0947);

	this.instance_2 = new lib.Bitmap8();
	this.instance_2.setTransform(777,557,0.2471,0.2471);

	this.instance_3 = new lib.Bitmap7();
	this.instance_3.setTransform(126,215,0.375,0.375);

	this.instance_4 = new lib.Bitmap6();
	this.instance_4.setTransform(696,173,0.1688,0.1688);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	// add_transition
	this.instance_5 = new lib.transition();
	this.instance_5.setTransform(480,320,1,1,0,0,0,0,-320);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1));

	// background
	this.instance_6 = new lib.IMG_20210318_133744();
	this.instance_6.setTransform(0,0,0.2344,0.2344);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IMG_20210318_133744.jpg?1665113357360", id:"IMG_20210318_133744"},
		{src:"images/Untitled_3_atlas_1.png?1665113357309", id:"Untitled_3_atlas_1"}
	],
	preloads: []
};
