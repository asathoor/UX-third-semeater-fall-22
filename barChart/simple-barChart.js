...
// stage content:
(lib.simplebarChart = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// button
	this.text = new cjs.Text("Barcharts Made Simple", "18px 'Monaco'", "#FF0000");
	this.text.lineHeight = 25;
	this.text.lineWidth = 290;
	this.text.parent = this;
	this.text.setTransform(495,22);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.button_1},{t:this.text}]}).wait(100));
...
p.nominalBounds = new cjs.Rectangle(439,320,348,251.10000000000002);
// library properties:
lib.properties = {
